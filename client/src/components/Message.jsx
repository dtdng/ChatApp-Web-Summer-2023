      ...
      <div className="messageContent">
        {message.text !== "" && (
          <p
            data-toggle="tooltip"
            data-placement="top"
            title={message.date.toDate().toString()}
          >
            {message.text}
            {call_again === "call_again" ? (
              <button id="call_again" onClick={handleSelect}>
                Goi lai
              </button>
            ) : null}
            {call_again === "join" ? (
              <button id="call_again" onClick={handleJoin}>
                Join
              </button>
            ) : null}
          </p>
        ...
        {message.img && type === "audio" ? (
          <audio controls src={message.img} className="voice"></audio>
        ) : null}
        {message.img &&
        type !== "image" &&
        type !== "video" &&
